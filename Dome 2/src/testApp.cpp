...
public:
    ...
    vector<ofFloatColor> getColors() {
        ...
        c.push_back(ofFloatColor(r,g,b,1));
        endfor
        endfor
        return c;
    }
...
void testApp::setup(){
    ...
    displaceShader.load("Shaders/vertex-displacement-noise");
    
    ofDisableArbTex();
    explosion.loadImage("Textures/Explosion.png");
    ofEnableArbTex();
...
//        ofEnableBlendMode(OF_BLENDMODE_ADD);
        ...
        displaceShader.setUniformTexture("tExplosion", explosion, 0);
        displaceShader.setUniform1f("u_time", ofGetElapsedTimef() );
		ofNoFill();
        glLineWidth(0.1);
        glPointSize(5);
